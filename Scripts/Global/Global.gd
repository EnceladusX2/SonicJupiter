...
# global check to see if we want the characters to pose at the end of acts.
var doVictoryPose = false
...
var themes = [preload("res://Audio/Music/invincibility.ogg"),preload("res://Audio/Music/speed_shoes.ogg"),preload("res://Audio/Music/zone_complete.ogg")]
...
# add a score object, see Scripts/Misc/Score.gd for reference
